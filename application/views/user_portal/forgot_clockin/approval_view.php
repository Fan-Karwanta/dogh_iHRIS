...
<div class="card-custom">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5><i class="fas fa-file-alt mr-2"></i>Review Clock Change Request - <?= htmlspecialchars($request->control_no) ?></h5>
        <a href="<?= site_url('clockchangeapproval') ?>" class="btn btn-secondary btn-sm">
    ...
    <div class="card-body">
        ...
        <div class="mt-4" style="max-width: 700px; margin: 20px auto 0;">
            ...
            <div class="d-flex justify-content-center">
                <form action="<?= site_url('clockchangeapproval/approve/' . $request->id) ?>" method="post" class="d-inline mr-2" id="approveForm">
                    <input type="hidden" name="remarks" id="approveRemarks">
                    <button type="submit" class="btn btn-success btn-lg" onclick="document.getElementById('approveRemarks').value=document.getElementById('remarks').value; return confirm('Approve this request?')">
                        <i class="fas fa-check mr-2"></i>Approve
                    </button>
                </form>
                <form action="<?= site_url('clockchangeapproval/reject/' . $request->id) ?>" method="post" class="d-inline" id="rejectForm">

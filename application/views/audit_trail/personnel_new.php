        ...
        <div class="card card-profile">
            ...
            <div class="card-body">
                <div class="user-profile text-center">
                    ...
                    <!-- Enhanced Personnel Details -->
                    <div class="row mt-4">
                        <div class="col-md-3">
                            <div class="info-item">
                                <span class="info-label">Biometrics ID</span>
                                <span class="info-value"><?= $personnel->bio_id ?></span>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="info-item">
                                ...
                                <span class="info-value">
                                    <?php 
                                    $employment_type = isset($personnel->employment_type) ? $personnel->employment_type : 'Regular';
                                    $badge_class = $employment_type == 'Regular' ? 'badge-success' : 'badge-warning';
                                    ?>
                                    <span class="badge <?= $badge_class ?>"><?= $employment_type ?></span>
                                </span>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="info-item">
                                ...
                                <span class="info-value"><?= isset($personnel->salary_grade) ? 'SG ' . $personnel->salary_grade : 'N/A' ?></span>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="info-item">
                                <span class="info-label">Schedule</span>
                                <span class="info-value"><?= isset($personnel->schedule_type) ? $personnel->schedule_type : '8:00 AM - 5:00 PM' ?></span>
                            </div>
                        </div>
                    </div>
                    
                    <?php if (isset($personnel->timestamp) && $personnel->timestamp): ?>
                    <div class="row mt-3">
                        <div class="col-md-12">
                            <div class="info-item">
                                <span class="info-label">Registration Date</span>
                                <span class="info-value"><?= date('M j, Y g:i A', strtotime($personnel->timestamp)) ?></span>
                            </div>
                        </div>
                    </div>
                    <?php endif; ?>
